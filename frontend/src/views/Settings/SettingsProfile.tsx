...
export default function SettingsProfile() {
  ...
  // utilitaire de validation de pseudo
      ...
      <div className="profile-block">
          ...
          <div className="pseudo-area">
            {isEditingPseudo ? (
              <>
                <input
                  ref={pseudoInputRef}
                  className={`pseudo-input ${!isValidPseudo(pseudo) ? 'error' : ''}`}
                  value={pseudo}
                  maxLength={16}
        ...
        <div className="save-reset-container">
          <button
            ...
            onClick={handleSave}
            disabled={!isDirty || !isValidPseudo(pseudo)}
            type="button"
          >
            {t('save_button')}
          </button>
      ...
      <div className="twofa-block">
        ...
        {qrCodeUrl && (
          <div className="qr-section">
            <p className="qr-instruction">{t('scan_qr_code_instruction')}</p>
